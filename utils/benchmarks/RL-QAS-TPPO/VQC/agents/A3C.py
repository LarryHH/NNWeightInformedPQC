...
class A3C(nn.Module):
    def __init__(self, conf, action_size, state_size, device):
        ...
        neuron_list_actor = conf['agent']['neurons'] #example neurons = [1000,1000,1000,1000,1000]
        neuron_list_critic = conf['agent']['neurons'] #example neurons = [1000,1000,1000,1000,1000]
